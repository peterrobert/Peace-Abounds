  ...
  return (
    ...
    >
      <div className="max-w-[1440px] mx-auto px-6">
        <div className="bg-brand-sage rounded-[24px] p-12 md:p-20 text-center relative overflow-hidden shadow-lg max-w-5xl mx-auto">
          ...
          <div className="relative z-10">
            ...
            <p className="font-sans text-lg text-white/90 font-light leading-relaxed mb-10 max-w-2xl mx-auto">
              We invite you to visit Peace Abounds, meet our dedicated team, and
              see firsthand how our services can provide comfort and peace of
